...
public class Paxelitem extends DiggerItem {
    ...
    private Optional<BlockState> getStripped(BlockState unstrippedState) {
        return java.util.Optional.ofNullable((Block)STRIPPABLES.get(unstrippedState.getBlock())).map((p_150689_) -> (BlockState)p_150689_.defaultBlockState().setValue(RotatedPillarBlock.AXIS, (Direction.Axis)unstrippedState.getValue(RotatedPillarBlock.AXIS)));
    }
